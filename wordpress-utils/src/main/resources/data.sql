...
INSERT INTO APP_PROPERTY (key, value, description) VALUES ('db.config.nbResultsPerPage', '20', 'To set the number of raw to return per page [Spring boot "PagingAndSortingRepository<T, K> repo" + "Page<T> results = repo.findAll(new PageRequest(x, x + maxNumber)"]');
