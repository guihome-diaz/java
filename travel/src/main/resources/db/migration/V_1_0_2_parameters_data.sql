...
INSERT INTO PARAMETERS(PARAM_ID, PARAM_NAME, PARAM_VALUE, PARAM_TYPE, DESCRIPTION, VERSION, IS_SENSITIVE) VALUES (SEQ_PARAMETERS.nextval, 'APP.ENVIRONMENT', 'dev', 'java.lang.String', 'current environment', 1, 0);
-- Parameters caching
